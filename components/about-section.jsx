...
export default function AboutSection() {
  return (
    <motion.section id="about" className="py-16 md:py-24 bg-background" {...fadeInAnimation}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">About APEX Fitness</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-16">
          ...
          <motion.div {...fadeInAnimation} transition={{ duration: 0.6, delay: 0.4 }}>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="bg-foreground text-background px-4 py-2 rounded-full font-semibold">Expert Trainers</div>
              <div className="bg-primary text-primary-foreground px-4 py-2 rounded-full font-semibold">
                Luxury Amenities
              </div>
            </div>
        ...
        >
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="bg-foreground w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
