...
export default function FooterSection() {
  ...
  return (
    <motion.footer
      className="bg-foreground text-muted py-12"
      initial={{ opacity: 0 }}
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <Link href="/" className="flex items-center space-x-2 text-2xl font-bold text-background mb-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-background mb-4">Connect With Us</h3>
            ...
            <p className="text-sm">
              <strong className="text-background">Elite Hotline:</strong>
              <br />
              +1 (555) 123-APEX
            </p>
          </div>
        </div>
        <div className="border-t border-muted pt-8 text-center text-sm">
